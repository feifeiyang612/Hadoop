package com.yf.bigdata.hadoop.wordcount;

import com.yf.bigdata.hadoop.component.WordCountMapper;
import com.yf.bigdata.hadoop.component.WordCountReducer;
...
/**
 * @Author: YangFei
 * @Description: 组装作业 并提交到集群运行
 * @create: 2019-12-17 14:45
 */
public class WordCountApp {

    // 这里为了直观显示参数 使用了硬编码，实际开发中可以通过外部传参
    private static final String HDFS_URL = "hdfs://cluster";
    private static final String HADOOP_USER_NAME = "master";
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.set("dfs.namenode.rpc-address.cluster.nn1", "server1:9000");
        conf.set("dfs.namenode.rpc-address.cluster.nn2", "server2:9000");
